...
import { AUDIO_SAMPLES, WHATSAPP_URL } from "../lib/constants";

export default function AudioSamples() {
  return (
    <section id="ejemplos" className="py-16 sm:py-24 px-4">
      <div className="max-w-4xl mx-auto">
        <h2
          className="font-heading text-3xl sm:text-4xl font-bold text-cream text-center mb-4"
          data-animate
        >
          Escucha corridos reales
        </h2>
        <p
          className="text-muted text-center text-base sm:text-lg mb-12 max-w-lg mx-auto"
          data-animate
        >
          Cada corrido es unico. Aqui van 3 ejemplos de historias reales que ya
          convertimos en cancion.
        </p>

        {/* Audio cards */}
        <div className="grid md:grid-cols-3 gap-4 sm:gap-5" data-animate>
        ...
        {/* Section break image */}
        <div className="mt-14 rounded-2xl overflow-hidden" data-animate>
          <Image
            src="/images/construction.jpg"
            alt="Trabajador escuchando su corrido en la obra"
            width={1200}
            height={600}
